...
class Handwriting {
  ...
  init() {
    ...
    app.globalData.writeEmitter = new Emitter()
  }
  ...
  uploadScaleStart(e) {
    ...
    app.globalData.writeEmitter.emit('startLine', false)
  }
  // 笔迹移动
  uploadScaleMove(e) {
  ...
  retDraw() {
    ...
    this.ctx.draw()
    this.startLine = 0;
    app.globalData.writeEmitter.emit('startLine', true)
  }
  /* 完成签名 */
  subCanvas(){
    let _self = this
